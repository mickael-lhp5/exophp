...
function sumNumbers($firstNumber = 14, $secondNumber =36, $thirdNumber=42){
...
<body>
    ...
    <div class='text-center jumbotron'>
        ...
        <p><?= sumNumbers($firstNumber,$secondNumber,$thirdNumber) ?></p>
        <p><?=creerPersonnage ('louvel','Celine','assassin');?></p>
