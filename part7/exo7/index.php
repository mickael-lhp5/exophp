...
if(isset($_FILES['fileExercice'])){
    $pathInfoFile = pathinfo($_FILES['name']['extension']);
$fileExtension = $pathInfoFile;
}
?>
    ...
    <div class="container">
        <div class="row justify-content-center bg-light m-2">
            ...
            ?>
                ...
                <form class="" name="inscription" method="get" action="index.php" enctype="multipart/form-data">
